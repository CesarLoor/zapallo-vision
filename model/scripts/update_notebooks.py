...
NOTEBOOK_01_CELLS = _cells([
    ...
    code([
        ...
        "print(f'Dataset proc   : {\"OK\" if proc_ok else \"NO ENCONTRADO — ejecuta: python model/scripts/preprocess.py\"}')\n",
    ], cell_id="config"),
    ...
    code([
        ...
        "    print(f'  {cls:<20}: {n_dup} duplicados en {sum(len(v) for v in hash_map.values())}')\n",
        "del hashes_by_cls\n",
        "gc.collect()\n",
    ], cell_id="duplicates"),
